...
def particles_per_MU( energy ):
    ...
    # Second draft; normalized to 2cm
    #n_mu = (-4.801126438105941e-04)*E**4 + (0.366191305013310)*E**3 - (1.242528262482523e+02)*E**2 + (3.536265810106020e+04)*E + (6.281125527574175e+04)
    # Normalized to area under curve
    n_mu = (6.891176244170290e-05)*E**4 - (0.017143365846687)*E**3 - (27.527639706566852)*E**2 + (2.486033359061191e+04)*E + (4.423684090872349e+05)
    return n_mu
